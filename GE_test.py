...
class GE:
    def __init__(self, shape, num_layers=4, num_nodes=8, mutation_rate=0.1, genotype=None):
        self.shape = shape
                    ...
                    if codon[0] == 'nodes_var':
                        ...
                        for i in range(int(self.phenotype[-10])):
                            ...
                            for j in range(0, len(symbols_to_add)):
                                ...
                                genome.insert(7+j, symbols_to_add[j])
                            #if i != 0:
                                #self.grammar['expr'][0].insert(22+len(symbols_to_add), ',')
                                #genome.insert(7+j, ',')
